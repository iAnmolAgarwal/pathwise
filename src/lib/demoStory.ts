...
export const DEMO_STORY: DemoStep[] = [
  ...
  { kind: "chat", day: 27, role: "user", text: "The maths-for-ML course is heavy going. Is there a lighter way in?" },
  ...
  { kind: "feedback", day: 27, event: { type: "too_hard", catalogId: "imperial-math-ml" }, minute: 3 },
  ...
  { kind: "feedback", day: 6, event: { type: "completed", catalogId: "inria-sklearn-mooc" } },
  ...
  { kind: "feedback", day: 3, event: { type: "completed", catalogId: "kaggle-feature-engineering" } },
  ...
  { kind: "feedback", day: 1, event: { type: "completed", catalogId: "learnpytorch-io" } },
